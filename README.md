...
```
dependencies: [
    .package(url: "https://github.com/visioncc-vxi/visioncc-ios-sdk.git", .upToNextMajor(from: "1.4.5-15.0.1"))
]
...
dependencies: [
        ...
        .package(url: "https://github.com/realm/realm-swift.git", .upToNextMajor(from: "10.32.3"))
    ],
```
