...
let package = Package(
    ...
    targets: [
       ...
       .binaryTarget(
            name: "VisionCCiOSSDK", 
            url: "https://vcc-sdk.vxish.cn/sdk/xcode15.2/1.5.9/VisionCCiOSSDK.xcframework.zip",
            checksum: "ff0476308782e48e5efaadbd1686b67b27309d3e7040bb941ec6b348b2f94822"
        )
    ],
