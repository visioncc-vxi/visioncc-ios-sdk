...
let package = Package(
    ...
    targets: [
       ...
       .binaryTarget(
            name: "VisionCCiOSSDK", 
            url: "https://vcc-sdk.vxish.cn/sdk/xcode15.2/1.5.2/VisionCCiOSSDK.xcframework.zip",
            checksum: "723be3bbad8769efbddee430def8839a8057e75b9170b36e70a2585776547fea"
        )
    ],
