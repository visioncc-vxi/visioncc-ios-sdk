...
let package = Package(
    ...
    targets: [
       ...
       .binaryTarget(
            name: "VisionCCiOSSDK", 
            url: "https://vcc-sdk.vxish.cn/sdk/xcode15.2/1.4.5/VisionCCiOSSDK.xcframework.zip",
            checksum: "824282f2015d19b6f7600f1dfe7324f5ed2c2a659db347bc6c5108df5e8b8f43"
        )
    ],
