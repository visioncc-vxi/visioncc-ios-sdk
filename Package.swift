...
let package = Package(
    ...
    targets: [
       ...
       .binaryTarget(
            name: "VisionCCiOSSDK", 
            url: "https://vcc-sdk.vxish.cn/sdk/xcode15.2/1.5.10/VisionCCiOSSDK.xcframework.zip",
            checksum: "b81e64a6a3c1f61c33a5ca399e7104353b09cbc2b031fe7bd9592bb115d38dc4"
        )
    ],
