...
let package = Package(
    ...
    targets: [
       ...
       .binaryTarget(
            name: "VisionCCiOSSDK", 
            url: "https://vcc-sdk.vxish.cn/sdk/xcode15.0.1/1.5.3/VisionCCiOSSDK.xcframework.zip",
            checksum: "8393505eb13391d7bf8429bbb6dfebc06e84d75c6829abb8945a959efa2aae21"
        )
    ],
