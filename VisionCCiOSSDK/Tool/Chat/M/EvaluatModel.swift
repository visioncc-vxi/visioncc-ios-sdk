...
public struct EvaluatLabelModel : Codable {
    public var stfLabelsId:Int64?
    public var stfOptionsId:Int64?
    /// 标签名称
    public var labelsName:String?
    public var labelsValue:String?
    public var sort:Int?
...
public struct EvaluatOptionsModel : Codable {
    ...
    public var sort:Int?
    /// 标签是否必选（0：否，1：是）
    public var tagRequired:Bool?
    /// 备注是否必填（0：否，1：是）
    public var remarkRequired:Bool?
    /// 当前选项的名称
    public var optionsName:String?
    /// 当前选项的分值
    public var optionsScore:Int?
    /// 当前选项的icon
    public var optionsIcon:String?
    public var labels:[EvaluatLabelModel]?
...
public struct EvaluatResultModel : Codable {
    public var main:EvaluatResultMainModel?
    public var options:[EvaluatResultOptionsModel]?
...
public struct EvaluatResultMainModel : Codable {
    /// 会话满意度标识id
    public var satisfactionId:Int64?
    /// 满意度模板标识id
    ...
    /// 评价感谢文案
    public var appreciateWord:String?
    /// 评价模式 1-5级满意度
    public var pattern:Int?
    /// 启用已解决
    public var enableResolved:Bool?
    /// 是否越大越好
    public var biggerSocreBetter:Bool?
...
public struct EvaluatResultOptionsModel : Codable {
    /// 满意度设置选项id
    public  var stfOptionsId:Int64?
    public var choosedValues:[String]?
    public var choosedNames:[String]?
    public var sort:Int?
    /// 满意度模板配置的选项是否必选
    public var tagRequired:Bool?
    public var remarkRequired:Bool?
