...
class RecordingView: UIView {
    ...
    fileprivate func setupCancelSendView() {
        ...
        let imageView = UIImageView(image: UIImage(named: "dd_cancel_send_record", in: VXIUIConfig.shareInstance.getBundle(), compatibleWith: nil))
    ...
    fileprivate func setupShowVolumnState() {
        ...
        let imageView = UIImageView(image: UIImage(named: "ico_talk_hint_voice-tube", in: VXIUIConfig.shareInstance.getBundle(), compatibleWith: nil))
        ...
        let volumnImage = UIImageView(image: UIImage(named: "ico_talk_hint_volume", in: VXIUIConfig.shareInstance.getBundle(), compatibleWith: nil))
        volumnImage.frame = CGRect(x: imageView.yl_right + 6, y: imageView.yl_bottom - 33, width: 20, height: 33)
        volumnImage.contentMode = UIView.ContentMode.bottom
    ...
    fileprivate func setupShowRecordingTooShort() {
        ...
        let imageView = UIImageView(image: UIImage(named: "dd_record_too_short", in: VXIUIConfig.shareInstance.getBundle(), compatibleWith: nil))
