...
- (void)resetAnimated {
    dispatch_once(&_onceToken, ^{
        ...
        [[NSNotificationCenter defaultCenter] addObserver:weakSelf selector:@selector(didReceiveMemoryWarning:) name:UIApplicationDidReceiveMemoryWarningNotification object:nil];
